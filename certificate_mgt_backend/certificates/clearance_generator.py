...
def generate_clearance(obj):
   ...
   # Bottom-right notch
    ...
    c.drawCentredString(cert_center_x, cert_text_y + 10, "Clearance No.")
    ...
    label1 = "This clearance is valid until: "
    ...
    obj.generated_clearance.save(filename, ContentFile(buffer.read()))
    obj.save()
